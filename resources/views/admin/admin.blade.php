...
<head>
	<title>HisenseGH || SMS Login</title>
	<meta charset="utf-8">
			...
			<div class="row">
				...
				<div class="col-12 col-md-5 col-lg-4 d-md-flex align-items-center bg-grad vh-sm-100">
					<div class="w-100 p-3 p-lg-5 all-text-white">
						...
						<h3 class="fw-light">Welcome To Hisense SMS</h3>
					...
					<div class="row h-100">
						<div class="col-12 col-md-10 col-lg-5 text-start mx-auto d-flex align-items-center">
							<div class="w-100">
                                ...
                                @endforeach
                            @endif
								<form class="form mt-4 " method="POST" action="{{ route('admin.login') }}">
                                    @csrf
								
									<div>
										<p class="text-start mb-2">Email</p>
										<span class="form-group"><input type="email" class="form-control" placeholder="Email" name="email"></span>
									</div>
									<div>
									...
									<div class="row align-items-center g-0 m-0">
										<div class="col-6 col-md-8"><span class="text-muted"> <a href="#"></a></span></div>
										<div class="col-6 col-md-4 text-end"><button type="submit" class="btn btn-dark ">Lgin</button></div>
									</div>
								</form>
							</div>
						</div>
