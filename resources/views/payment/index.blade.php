...
@section('content')
        ...
        <div class="container d-flex justify-content-center">
            <ul class="nav nav-pills alternate nav-lg border-bottom-0 nav nav-pills nav-lg" id="pillsmyTab" role="tablist">
                ...
                @if ($banks[2]->status == 'ACTIVE')
                    <li class="nav-item"> <a class="nav-link fw-600" id="ubas" href="#uba" role="tab"
                            data-bs-toggle="tab" aria-controls="uba" aria-selected="true">UBA</a></li>
                @endif
                @if ($banks[0]->status == 'ACTIVE')
                    <li class="nav-item"> <a class="nav-link fw-600 " id="zeniths" href="#zenith" role="tab"
                            data-bs-toggle="tab" aria-controls="zenith" aria-selected="true">ZENITH BANK</a></li>
                @endif
                ...
                @if ($banks[3]->status == 'ACTIVE')
                    <li class="nav-item"> <a class="nav-link " id="gcbs" href="#gcb" role="tab"
                            data-bs-toggle="tab" aria-controls="gcb" aria-selected="true">GCB</a></li>
                @endif
            </ul>
        </div>
    </div>
    ...
    <div class="tab-content my-3" id="pillsmyTabContent">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-lg-4 col-xl-5 mx-auto">
                                <div class="bg-white shadow-sm rounded  p-4">
                                    <h3 class="text-5 fw-600 mb-3 mb-sm-4 text-center">ZENITH BANK</h3>
                                    <hr>
                                    <h3 class="text-center text-3 fw-400 mb-3 mb-sm-4">Customer Details</h3>
                                    <hr class="">

                                    <form id="form-send-money" method="post" action="{{ route('payments.zenith') }}">
                                        @csrf
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input step="any" min="0" required name="amount"
                                ...
                                <div class="bg-white shadow-sm rounded  p-4">
                                    ...
                                    <form id="form-send-money" method="post" action="{{ route('payments.pay') }}">
                                        ...
                                        <div class="mb-3">
                                            <label for="payerName" class="form-label">Full Name</label>
                                            <input required type="text" name="name" value=""
                                                class="form-control" data-bv-field="payerName" id="payerName"
                            ...
                            <div class="col-md-4 col-lg-4 col-xl-5 mx-auto">
                                ...
                                ============================================= -->
                                    <form id="form-send-money" method="post"
                                        action="{{ route('transactions.uba.pay') }}">
        ...
        @if ($banks[3]->status == 'ACTIVE')
            {{-- gcb --}}
            <div class="tab-pane fade show active" id="gcb" role="tabpanel" aria-labelledby="gcbs">
                <!-- Content
                      ============================================= -->
                <div id="content" class="py-4">
                    <div class="container">
