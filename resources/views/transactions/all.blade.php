                  ...
                  ============================================= -->
                    <div class="bg-white shadow-sm rounded p-4 mb-4">
                        ...
                        <div class="table-responsive mt-2">
                            <div class="d-md-flex justify-content-between flex-sm-column flex-md-row">
                                <div class="flex-grow-2">
                                    <div class="input-group input-group-sm mb-3 ">
                                        ...
                                        <input type="date" placeholder="" id="date1" name="date1"
                                            class="form-control form-control-sm search" aria-label="Sizing example input"
                                ...
                                <div class="flex-grow-2 mx-2">
                                    <div class="input-group input-group-sm mb-3 ">
                                        ...
                                        <input type="date" placeholder="search showrooms" name="date2" id="date2"
                                            class="form-control form-control-sm search" aria-label="Sizing example input"
                                            aria-describedby="inputGroup-sizing-sm">
                                    </div>
                                </div>
                                ...
                                <div class="mx-3 flex-grow-1 ">
                                    <h3 class="text-3 text-end  fw-600"> {{ $total }}</h3>
                                </div>
                            </div>
                            <div class="d-md-flex justify-content-between flex-sm-column flex-md-row">
                            ...
                            <table id="dataTable2" width="100%" class="table table-striped table-hover dataTable2 display"
