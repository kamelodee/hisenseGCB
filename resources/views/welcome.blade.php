...
<!-- Mirrored from wizixo.webestica.com/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 May 2022 00:59:04 GMT -->
<head>
	<title>Trucks Request</title>
	<meta charset="utf-8">
...
<link rel="stylesheet" type="text/css" href="{{asset("assets/assets/css/style.css")}}" />
	<!-- Plugins CSS -->
		<link rel="stylesheet" type="text/css" href="{{asset('assets/assets/vendor/glightbox/css/glightbox.css')}}">
...
<body>
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarCollapse">
					<ul class="navbar-nav navbar-nav-scroll navbar-nav-scroll ms-auto">
						...
						<li class="nav-item dropdown active">
							<a class="nav-link dropdown-toggle active" href="#" id="demosMenu" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Home</a>
				...
				<div class="navbar-nav">
					...
					<div class="nav-item border-0 d-none d-lg-inline-block align-self-center">
						<a href="{{route('login')}}" class=" btn btn-sm btn-grad text-white mb-0">Login</a>
					</div>
					<div class="nav-item border-0 d-none d-lg-inline-block align-self-center m-3">
						<a href="{{route('register')}}" class=" btn btn-sm btn-grad text-white mb-0">Register</a>
					</div>
				</div>
				<!-- Header Extras End-->
			</div>
		...
		<div class="container d-flex h-100">
			<div class="row align-self-center w-100">
				...
				<div class="col-md-6 mt-md-0 all-text-white position-relative">
					<h2 class="display-4 fw-normal">Welcome to HisenseGH sms</h2>
					<p class="h6 mb-4 fw-normal d-none d-sm-block">Bulk SMS </p>
					<a class="btn btn-dark mb-7" href="{{route('register')}}">Start Here</a>
				</div>
				<!-- banner image -->
				<div class="col-md-6 d-none d-md-block p-0 position-absolute top-0 end-0 align-top align-text-top">
					...
					<g id="XMLID_81_">
						...
						<g style="clip-path:url(#XMLID_83_);">
							...
							<image style="overflow:visible;" width="1290" height="1024" id="XMLID_82_" xlink:href="{{asset('assets/assets/images/banner/10.jpg')}}"  transform="matrix(0.9999 0 0 0.9999 8.063897e-002 6.401104e-002)">
							</image>
						</g>
					</g>
				</svg>
			...
			<div class="row">
				<div class="col-12 col-lg-8 mx-auto">
					<div class="title text-center">
						<span class="pre-title">Welcome to our website</span>
			...
			<div class="row">
				<div class="col-sm-6 col-md-3">
					<div class="feature-box h-100 text-center">
						<div class="feature-box-icon"><img class="w-50" src="assets/images/clients/03.png" alt=""></div>
						<h3 class="feature-box-title">Free access</h3>
						<p class="feature-box-desc">Depending in newspaper an September do existence strangers. Total great saw water new relation diverted.</p>
					</div>
				</div>
				<div class="col-sm-6 col-md-3">
					<div class="feature-box h-100 text-center">
						<div class="feature-box-icon"><img class="w-50" src="assets/images/clients/02.png" alt=""></div>
						<h3 class="feature-box-title">Awesome interface</h3>
						<p class="feature-box-desc">Continue delicate as unlocked entirely mr relation diverted in. Known not end fully being totally of in chiefly. </p>
					</div>
				</div>
				<div class="col-sm-6 col-md-3">
					<div class="feature-box h-100 text-center">
						<div class="feature-box-icon"><img class="w-50" src="assets/images/clients/01.png" alt=""></div>
						<h3 class="feature-box-title">Retina supported</h3>
						<p class="feature-box-desc">Outlived it received he material. Took yourself joy moderate off repeated laughter screened spot soon size you. </p>
					</div>
				</div>
				<div class="col-sm-6 col-md-3">
					<div class="feature-box h-100 text-center">
						<div class="feature-box-icon"><img class="w-50" src="assets/images/clients/04.png" alt=""></div>
						<h3 class="feature-box-title">User friendly</h3>
						<p class="feature-box-desc">Continue delicate as unlocked entirely mr relation diverted in. Known not end fully being style house totally. </p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row justify-content-between align-items-center">
				...
				<div class="col-md-6">
					...
					<svg version="1.1" id="about-image" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 678 595" style="enable-background:new 0 0 678 595;" xml:space="preserve">
						<defs>
						...
						<path id="about-image-bg" fill="url(#BgGradient)" d="M652.2,493.6c-51.9,58.8-395.9,51.9-395.9,51.9S7.4,581.8,50.6,396.8
							...
							<g id="XMLID_120_">
								...
								<path id="XMLID_7_" d="M635.5,506.9c-51.9,58.8-395.9,51.9-395.9,51.9S-9.3,595,34,410C65.6,274.7-14.4,69.5,80.6,33.2
									...
									<g style="clip-path:url(#XMLID_155_);">
										...
										<image style="overflow:visible;" width="700" height="700" id="XMLID_121_" xlink:href="assets/images/service/09.jpg"  transform="matrix(0.9999 0 0 0.9999 1 -81)">
										</image>
									</g>
								</g>
				...
				<div class="col-md-6 mt-4 mt-md-0">
					...
					<h2 class="h1">Your technical partner towards web success.</h2>
					<p class="lead">Our friendly team members are always willing to help you understand your present technology requirements and provide suggestions on your future needs.</p>
					<p> Additions can suspected its concealed put furnished. Met the why particular devonshire decisively considered partiality. Certain it waiting no entered is. Passed her indeed uneasy shy polite appear denied. Oh less girl no walk. At he spot with five of view.</p>
					<p><span class="text-dark fw-bold">— Jessica Mores,</span> CEO wizixo</p>
					<div class="row">
						<div class="col-5"><img src="assets/images/mockups/signature.png" alt=""></div>
					</div>
				</div>
			</div>
		</div>
	...
	<!-- =======================
	counter -->
	{{-- <section class="p-0 counter counter-small">
		<div class="container">
			<div class="row ">
				<div class="col-md-12">
					<div class="bg-dark rounded py-5 all-text-white pattern-overlay-2">
						<div class="row">
							<!-- count item -->
							<div class="col-md-3 col-6 mb-4 mb-sm-0">
							...
							<div class="col-md-3 col-6 mb-4 mb-sm-0">
								<div class="text-center">
									...
									<h2 class="fw-bold mt-2 mb-0 purecounter" data-purecounter-start="0" data-purecounter-delay="10" data-purecounter-duration="1" data-purecounter-end="865">0</h2>
							...
							<div class="col-md-3 col-6">
								<div class="text-center">
									...
									<h2 class="fw-bold mt-2 mb-0 purecounter" data-purecounter-start="0" data-purecounter-delay="10" data-purecounter-duration="1" data-purecounter-end="127">0</h2>
							...
							<div class="col-md-3 col-6">
								<div class="text-center">
									<i class="display-6 ti-cup"></i>
									<h2 class="fw-bold mt-2 mb-0 purecounter" data-purecounter-start="0" data-purecounter-delay="80" data-purecounter-duration="10" data-purecounter-end="16">0</h2>
	...
	<section class="portfolio portfolio-style-2 pb-0">
		<div class="container">
			<div class="row">
				<div class="col-12 col-lg-8 mx-auto">
					<div class="title text-center">
						<span class="pre-title">Our SMS </span>
						<h2>How it works </h2>
						<p class="mb-0">Register and start sending SMS</p>
					</div>
				</div>
			</div>
			<div class="row">
	...
	<section class="py-5">
		<div class="container">
			<div class="row">
				<div class="col-md-9 text-center text-md-start align-self-center">
					<h4 class="m-0">Start Now</h4>
				</div>
				<div class="col-md-3 text-center text-md-end mt-3 mt-md-0 align-self-center ">
	...
	<section class="bg-grad p-4 p-sm-5">
		<div class="container">
			<div class="d-block all-text-white">
				<div class="text-center">
					<h3 class="m-0">Start sending bulk sms today</h3>
				</div>
			</div>
		</div>
	</section>
					...
					<div class="col-md-5 mx-auto text-center pt-5">
						...
						<form class="my-4">
							<div class="input-group shadow">
								...
								<button type="button" class="btn btn-grad btn-lg rounded-0 m-0">
									<span><i class="far fa-paper-plane m-0"></i></span>
								</button>
							</div>
						</form>
						<div class="copyright-text">©2022 All Rights Reserved by <a href="#!"> HisensenGHSMS</a></div>
					</div>
				</div>
			</div>
		</div>
...
<!-- Mirrored from wizixo.webestica.com/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 May 2022 00:59:05 GMT -->
</html>