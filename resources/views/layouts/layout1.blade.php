            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item p-2">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ route('admin.sms') }}"
                                aria-expanded="false">
                        ...
                        <li class="sidebar-item p-2">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ route('admin.groups') }}"
                                aria-expanded="false">
                        ...
                        <li class="sidebar-item p-2">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ route('admin.senderids') }}"
                                aria-expanded="false">
